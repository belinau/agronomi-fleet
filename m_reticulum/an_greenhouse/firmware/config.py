...
Actuators: vent relay, shade PWM, fan relay (all active HIGH)
"""
...
# ---- Actuator pins ----
PIN_VENT_RELAY = 5   # vent open/close
PIN_SHADE_PWM = 6    # shade percentage (0–100%)
PIN_FAN_RELAY = 7    # fan on/off

# ---- Battery ADC (100k/100k divider on GPIO1) ----
# Greenhouse nodes are typically mains-powered; ADC reserved but disabled.
